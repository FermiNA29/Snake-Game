...
function drawCell(ctx, x, y, color, img) {
    ctx.fillStyle = color;
...
function draw() {
    setInterval(function() {
        ...
        drawCell(ctx, snake1.position.x, snake1.position.y, snake1.color, document.getElementById("snake1"));
        drawCell(ctx, snake2.position.x, snake2.position.y, snake2.color, document.getElementById("snake2"));
        drawCell(ctx, snake3.position.x, snake3.position.y, snake3.color, document.getElementById("snake3"));
        drawCell(ctx, apple.position.x, apple.position.y, apple.color, document.getElementById("apple"));
        drawCell(ctx, apple2.position.x, apple2.position.y, apple2.color, document.getElementById("apple2"));
